...
const cropSchema = new mongoose.Schema(
  {
    ...
    processingDetails: { type: String, enum: ["Raw", "Semi-processed", "Packaged"] },
    qualityGrade: { type: String, enum: ["A", "B", "C", "Organic Certified"] },
    certifications: { type: [String] },
    quantityAvailable: { type: Number },
    totalQuantity: { type: Number, required: true },
    unitOfcrop: { type: String, required: true, enum: ["kg", "quintal", "ton"] },
    pricePerUnit: { type: Number, required: true },
    bulkDiscount: { type: String },
    negotiable: { type: Boolean, default: true },
    storageType: { type: String },
    deliveryOptions: { type: String, enum: ["Pickup", "Delivery", "Both"] },
    interestedDealers: [{ user: { type: mongoose.Types.ObjectId, ref: "Users" }, markDone: { type: Boolean, default: false } }],
