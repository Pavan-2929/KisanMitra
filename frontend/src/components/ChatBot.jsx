...
const ChatBot = () => {
    ...
    return (
        <div>
            ...
            {<div className={`z-30 w-full lg:w-[50vw] fixed top-0 right-0 transform transition-transform duration-700 ease-in-out ${!show ? 'translate-x-full' : "translate-x-0"}`} id=''>
